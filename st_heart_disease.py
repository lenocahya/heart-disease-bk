...
# ======================================
# Pada minggu pertama dan kedua telah menyelesaikan model klasifikasi hingga evaluasi
# kali ini deployment model atau studi kasus yang telah dibuat.
# Telah terbuat model yang dirasa paling optimal sehingga pada kode
# ini akan mengambil model yang telah diexport untuk dapat diaplikasikan pada
# deployment ini
# ======================================
